...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			div4 = element("div");
			h32 = element("h3");
			t10 = text("fontawesome is wonky...");
			t11 = space();
			h41 = element("h4");
			t12 = text("it was okay on localhost");
			t13 = space();
			div5 = element("div");
			p1 = element("p");
			t14 = text("fontawesome control is loose...");
			t15 = space();
			li2 = element("li");
			div9 = element("div");
			div7 = element("div");
			h33 = element("h3");
			t16 = text("how to npm bootstrap and fontawesome");
			t17 = space();
			h42 = element("h4");
			t18 = text("how do we scaffold that in plenti");
			t19 = space();
			div8 = element("div");
			p2 = element("p");
			t20 = text("how does plenti or go scaffold npm modules?");
			t21 = space();
			li3 = element("li");
			div12 = element("div");
			div10 = element("div");
			h34 = element("h3");
			t22 = text("would you accept this template as a plenti theme?");
			t23 = space();
			h43 = element("h4");
			t24 = text("it needs some more work");
			t25 = space();
			div11 = element("div");
			p3 = element("p");
			t26 = text("i feel like i should attribute a link to the original theme");
			t27 = space();
			li4 = element("li");
			div15 = element("div");
			div13 = element("div");
			h35 = element("h3");
			t28 = text("live surge deploy");
			t29 = space();
			div14 = element("div");
			p4 = element("p");
			a0 = element("a");
			t30 = text("claxxicons.surge.sh");
			t31 = space();
			li5 = element("li");
			div18 = element("div");
			div16 = element("div");
			h36 = element("h3");
			t32 = text("github repo...");
			t33 = space();
			div17 = element("div");
			p5 = element("p");
			a1 = element("a");
			t34 = text("https://github.com/claxxmoldii/claxxicons");
			this.h();
		},
		l(nodes) {
			...
			t10 = claim_text(h32_nodes, "fontawesome is wonky...");
			h32_nodes.forEach(detach);
			t11 = claim_space(div4_nodes);
			h41 = claim_element(div4_nodes, "H4", { class: true });
			var h41_nodes = children(h41);
			t12 = claim_text(h41_nodes, "it was okay on localhost");
			...
			t14 = claim_text(p1_nodes, "fontawesome control is loose...");
			...
			t16 = claim_text(h33_nodes, "how to npm bootstrap and fontawesome");
			h33_nodes.forEach(detach);
			t17 = claim_space(div7_nodes);
			h42 = claim_element(div7_nodes, "H4", { class: true });
			var h42_nodes = children(h42);
			t18 = claim_text(h42_nodes, "how do we scaffold that in plenti");
			...
			t20 = claim_text(p2_nodes, "how does plenti or go scaffold npm modules?");
			...
			t22 = claim_text(h34_nodes, "would you accept this template as a plenti theme?");
			h34_nodes.forEach(detach);
			t23 = claim_space(div10_nodes);
			h43 = claim_element(div10_nodes, "H4", { class: true });
			var h43_nodes = children(h43);
			t24 = claim_text(h43_nodes, "it needs some more work");
			...
			t26 = claim_text(p3_nodes, "i feel like i should attribute a link to the original theme");
			...
			t28 = claim_text(h35_nodes, "live surge deploy");
			...
			a0 = claim_element(p4_nodes, "A", { href: true, class: true });
			var a0_nodes = children(a0);
			t30 = claim_text(a0_nodes, "claxxicons.surge.sh");
			...
			div18 = claim_element(li5_nodes, "DIV", { class: true });
			var div18_nodes = children(div18);
			div16 = claim_element(div18_nodes, "DIV", { class: true });
			var div16_nodes = children(div16);
			h36 = claim_element(div16_nodes, "H3", {});
			var h36_nodes = children(h36);
			t32 = claim_text(h36_nodes, "github repo...");
			h36_nodes.forEach(detach);
			div16_nodes.forEach(detach);
			t33 = claim_space(div18_nodes);
			div17 = claim_element(div18_nodes, "DIV", { class: true });
			var div17_nodes = children(div17);
			p5 = claim_element(div17_nodes, "P", { class: true });
			var p5_nodes = children(p5);
			a1 = claim_element(p5_nodes, "A", { href: true, class: true });
			var a1_nodes = children(a1);
			t34 = claim_text(a1_nodes, "https://github.com/claxxmoldii/claxxicons");
		...
		h() {
			...
			attr(a0, "href", "https://claxxicons.surge.sh");
			attr(a0, "class", "svelte-10tf304");
			attr(p4, "class", "text-muted");
			attr(div14, "class", "timeline-body");
			attr(div15, "class", "timeline-panel");
			attr(div16, "class", "timeline-heading");
			attr(a1, "href", "https://github.com/claxxmoldii/claxxicons");
			attr(a1, "class", "svelte-10tf304");
			attr(p5, "class", "text-muted");
			attr(div17, "class", "timeline-body");
			attr(div18, "class", "timeline-panel");
			attr(ul, "class", "timeline-inverted svelte-10tf304");
			attr(div19, "class", "container");
			attr(section, "id", "issues");
			attr(section, "class", "page-section issues svelte-10tf304");
		},
		m(target, anchor) {
