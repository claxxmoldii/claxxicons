...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			p4 = element("p");
			a1 = element("a");
			t28 = text("https://github.com/claxxmoldii/claxxicons");
			this.h();
		},
		l(nodes) {
			...
			t12 = claim_text(h41_nodes, "how do we scaffold that on plenti");
			...
			t14 = claim_text(p1_nodes, "i'm using npm as a verb now, sorry... how do we use npm modules with plenti? there are lots of svelte components available as npm modules and i wonder how i could use it with plenti. i got this free template working with bootstrap and fontawesome. but the script calls are inside the body tag, or is that perfectly okay.");
			...
			a0 = claim_element(p3_nodes, "A", { href: true, class: true });
			var a0_nodes = children(a0);
			t24 = claim_text(a0_nodes, "claxxicons.surge.sh");
			...
			t28 = claim_text(a1_nodes, "https://github.com/claxxmoldii/claxxicons");
