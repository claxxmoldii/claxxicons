...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(i0, "class", "fas fa-circle fa-stack-2x text-primary dis-circle svelte-w3clnw");
			attr(i1, "class", "fas fa-shopping-cart fa-stack-1x fa-inverse");
			attr(span0, "class", "fa-stack fa-4x icons");
			attr(h40, "class", "my-3");
			attr(p0, "class", "text-muted");
			attr(div1, "class", "col-md-4");
			attr(i2, "class", "fas fa-circle fa-stack-2x text-primary dis-circle svelte-w3clnw");
			...
			attr(i4, "class", "fas fa-circle fa-stack-2x text-primary dis-circle svelte-w3clnw");
